#!/usr/bin/env bash
# ==============================================================================
# ScatterID — Quickstart & Automated Onboarding Bootstrap
# ==============================================================================
# This script provisions cryptographic keys, internal TLS certificates,
# initializes the Hyperledger Fabric blockchain and HashiCorp Vault KMS,
# boots the containerized microservices, and performs readiness health checks.
#
# Usage:
#   ./quickstart.sh          # Standard turnkey startup
#   ./quickstart.sh --build  # Force container image rebuild
# ==============================================================================
...
export VAULT_ROLE_ID=$(docker exec -e VAULT_ADDR=http://127.0.0.1:8200 -e VAULT_TOKEN=scatterid-vault-root-token vault.scatterid.com vault read -field=role_id auth/approle/role/issuer-role/role-id 2>/dev/null || echo "")
export VAULT_SECRET_ID=$(docker exec -e VAULT_ADDR=http://127.0.0.1:8200 -e VAULT_TOKEN=scatterid-vault-root-token vault.scatterid.com vault write -f -field=secret_id auth/approle/role/issuer-role/secret-id 2>/dev/null || echo "")
