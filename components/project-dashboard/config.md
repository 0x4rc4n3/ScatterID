# Component Technical Specification: config.js (Project Dashboard)

## 1. Purpose & Core Responsibility
- Provides a centralized configuration loader for the dashboard backend.
...
- **Allowed Inbound (Who can talk TO this file):** 
  - Dashboard modules via JavaScript imports.
